...
//                    status.pic_urls.add(tmpObject.optString("thumbnail_pic"));
                    String pic_small = tmpObject.optString("thumbnail_pic");
                    System.out.println("---small"+pic_small);
                    //换成大图片
                    String pic_large = pic_small.replace("thumbnail", "large");
                    System.out.println("---large"+pic_large);
                    status.pic_urls.add(pic_large);
                }
            }
